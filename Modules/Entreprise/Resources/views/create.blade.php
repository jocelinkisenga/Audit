              ...
              <form>
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputEmail4" placeholder="Lushidev">
                  </div>
                  <div class="mb-3 col-md-6">
                    <label class="form-label" for="inputPassword4">N° de téléphone</label>
                    <input type="text" class="form-control" id="inputPassword4" placeholder="0991161449">
                  </div>
                </div>
                <div class="row">
                    <div class="mb-3 col-md-6">
                ...
                <input type="text" class="form-control" id="inputAddress" placeholder="av. kansenya, N°12">
                </div>
                <div class="row">
                  <div class="mb-3 col-md-6">
